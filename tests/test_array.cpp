...
#include "../src/collections/Array.hpp"
	...
	SECTION("Instantiation")
	{
		...
		SECTION("Non-primitive types")
		{
			SECTION("Array<const char*> Array")
			{
				...
				REQUIRE(strcmp(arraycc[0], "A") == 0);
				REQUIRE(strcmp(arraycc[1], "BRUNO") == 0);
				REQUIRE(strcmp(arraycc[2], "LOREM") == 0);
				REQUIRE(strcmp(arraycc[3], "TEST") == 0);
