...
TEST_CASE("Last element manipulation from array")
{
    SECTION("Trying to remove an element from an empty array")
    {
        Array<float> fArray{};
...
TEST_CASE("Validating Array::ArrayValue proxy class to handle operator[]")
{
    SECTION("Getter")
    {
...
TEST_CASE("Obtain index information according to argument")
{
...
TEST_CASE("Check if element exists in array")
{
...
TEST_CASE("Count the amount of the same element in Array")
{
...
TEST_CASE("Fill array with the same element")
{
