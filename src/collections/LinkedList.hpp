...
#ifndef CPPDATASTRUCTURES_LINKEDLIST_HPP
#define CPPDATASTRUCTURES_LINKEDLIST_HPP
...
public:
    ...
    inline constexpr bool operator!=(const LinkedList &other) const noexcept {
        return !(*this == other);
    }
...
#endif //CPPDATASTRUCTURES_LINKEDLIST_HPP