...
#ifndef CPPDATASTRUCTURES_SBYTE_H
#define CPPDATASTRUCTURES_SBYTE_H
...
public:
     ...
     */
    template<typename T, std::enable_if_t<is_promotion_primitive<T>::value, bool> = true>
    constexpr SByte operator=(T const& value) noexcept requires(is_promotion_primitive<T>::value) { return Value = value; };
...
#endif //CPPDATASTRUCTURES_SBYTE_H
